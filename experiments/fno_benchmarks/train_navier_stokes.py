...
# Using generic fallback for spherical
dummy_sph_config = dict(n_modes=(16, 16), hidden_channels=32, in_channels=1, out_channels=1, n_layers=4)
model = TOPOS(
        spherical_config=dummy_sph_config,
